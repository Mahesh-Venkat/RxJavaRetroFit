...
public class MovieRepository {
    ...
    public void setMoviesLiveData(MutableLiveData<List<Movie>> moviesLiveData) {
    ...
    public void getPopularMoviesWithRx() {
        ...
        movieDBResponseObservable = getMoviesDataService.getPopularMoviesWithRx(application.getResources().getString(R.string.api_key));
